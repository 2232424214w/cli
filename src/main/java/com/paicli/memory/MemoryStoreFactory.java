 ...
 *
 * 配置驱动：
 * - `paicli.memory.backend` 系统属性 或 `PAICLI_MEMORY_BACKEND` 环境变量
...
public class MemoryStoreFactory {
    ...
    private static final String BACKEND_PROPERTY = "paicli.memory.backend";
    private static final String BACKEND_ENV = "PAICLI_MEMORY_BACKEND";
