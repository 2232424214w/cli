package com.bettercli.mcp.transport;
    ...
    private void startStdoutReader() {
        Thread thread = new Thread(() -> {
            try (BufferedReader reader = new BufferedReader(
                ...
                appendStderr("[bettercli] stdout reader stopped: " + e.getMessage());
            }
        }, "bettercli-mcp-stdio-stdout");
    ...
    private void startStderrReader() {
        Thread thread = new Thread(() -> {
            try (BufferedReader reader = new BufferedReader(
                ...
                appendStderr("[bettercli] stderr reader stopped: " + e.getMessage());
            }
        }, "bettercli-mcp-stdio-stderr");
        thread.setDaemon(true);
        thread.start();
    }
