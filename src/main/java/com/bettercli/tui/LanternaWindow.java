...
public final class LanternaWindow {
     ...
     */
    public LanternaWindow(BetterCliConfig config, LlmClient llmClient) throws IOException {
        ...
        this.mainWindow = new BasicWindow("BetterCLI v16.0.0");
    ...
    public BetterCliConfig getConfig() {
        return config;
    }
}
