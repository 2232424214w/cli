...
import com.bettercli.tui.history.ConversationSnapshot;
import com.bettercli.tui.pane.CenterPane;
import com.bettercli.tui.pane.StatusPane;
...
public final class TuiSessionController implements AutoCloseable {
    ...
    public TuiSessionController(BetterCliConfig config,
                                LlmClient llmClient,
                                Agent reactAgent,
        ...
        this.executor = Executors.newSingleThreadExecutor(r -> {
            Thread thread = new Thread(r, "bettercli-tui-agent-runner");
