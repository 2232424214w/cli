...
class RendererFactoryTest {
    ...
    @BeforeEach
    void saveProp() {
        savedProp = System.getProperty("bettercli.renderer");
    }
    ...
    void restoreProp() {
        if (savedProp == null) {
            ...
            System.setProperty("bettercli.renderer", savedProp);
        }
    }
    ...
    void propertyValuePlainResolves() {
        System.setProperty("bettercli.renderer", "plain");
    ...
    void unknownValueFallsBackToInline() {
        System.setProperty("bettercli.renderer", "weird");
        assertEquals(RendererFactory.Mode.INLINE, RendererFactory.resolveMode());
    }

    @Test
    void tuiAliasResolvesToLanterna() {
        System.setProperty("bettercli.renderer", "tui");
        assertEquals(RendererFactory.Mode.LANTERNA, RendererFactory.resolveMode());
    }
