...
class McpToolRegistrationTest {
    ...
    private static void withAuditDir(Path tempDir, ThrowingRunnable body) throws Exception {
        String previous = System.getProperty("bettercli.audit.dir");
        System.setProperty("bettercli.audit.dir", tempDir.resolve("audit").toString());
        try {
            body.run();
        } finally {
            if (previous == null) {
                ...
                System.setProperty("bettercli.audit.dir", previous);
            }
        }
    }
