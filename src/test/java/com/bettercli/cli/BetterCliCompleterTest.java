...
class BetterCliCompleterTest {

    @Test
    void suggestsSlashCommandsWhenInputStartsWithSlash() {
        BetterCliCompleter completer = new BetterCliCompleter(List::of);
    ...
    void completesSkillNames() {
        BetterCliCompleter completer = new BetterCliCompleter(List::of, () -> List.of(
